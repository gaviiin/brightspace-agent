...
describe("TopicSupplementary: empty state", () => {
  it("shows a hint and the Find supplementary materials button", async () => {
    mockedGetTopicEnrichment.mockResolvedValue(enrichmentFixture({ resources: [], meta: { suggested: 0, kept: 0, dismissed: 0 } }));
    renderSupplementary();

    await screen.findByText(/no supplementary materials yet/i);
